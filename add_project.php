          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Add Data Project</p>
                <form class="mx-1 mx-md-4" method="post" action="assets/lib/add_project.php">
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" id="form3Example1c" name="project_name" class="form-control" required/>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" id="form3Example3c" name="project_client" class="form-control" required/>
                  ...
                  <div class="form-group">
                    <input type="range" class="form-control-range" id="formControlRange" name="progress" value="0" required>
